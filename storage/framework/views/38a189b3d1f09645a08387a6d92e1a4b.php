            ...
            <div class="col-xl-3 col-md-4">
                <div class="my-account-menu mt-30">
                    <ul class="nav account-menu-list flex-column">
                        ...
                        <li>
                            <a href="<?php echo e(URL::to('/ordered')); ?>"><i class="fa fa-shopping-cart"></i> Đơn Đặt Hàng</a>
                        </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <div class="col-md-8 mt-10">
                                                <div class="account-address">
                                                    <div class="profile__info-body-left-item">
                                                        ...
                                                        <span class="profile__info-body-left-item-text ml-20"><?php echo e($customer->username); ?></span>
                                                    </div>
                                                    <div class="form-group mb-30">
                                                        <span for="CustomerName" class="profile__info-body-left-item-title" style="margin: 0 28px 0 52px;">Họ Và Tên</span>
                                                        <input id="CustomerName" name="CustomerName" class="ml-30" style="width:65%;" type="text" value="<?php echo e($customer->CustomerName); ?>">
                                                    </div>
                                                    <div class="form-group mb-30">
                                                        <span class="profile__info-body-left-item-title" style="margin-left: 52px;">Số Điện Thoại</span>
                                                        <input class="ml-30" style="width:65%;" name="PhoneNumber" id="PhoneNumber" type="text" value="<?php echo e($customer->PhoneNumber); ?>">
                                                    </div>
                                                ...
                                                <div class="profile__info-body-right-avatar">
                                                    <div class="profile-img-edit">
                                                        <div class="crm-profile-img-edit">
                                                            ...
                                                            <img class="crm-profile-pic rounded-circle avatar-100 replace-avt" src="storage/kidoldash/images/customer/<?php echo e($customer->Avatar); ?>">
                                                            <?php else: ?> <img class="crm-profile-pic rounded-circle avatar-100 replace-avt" src="kidoldash/images/user/1.png"> <?php endif; ?>
...
<script src="<?php echo e(asset('kidolshop/js/jquery.validate.min.js')); ?>"></script>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views\shop\customer\my-account.blade.php ENDPATH**/ ?>