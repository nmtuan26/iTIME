        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form  method="post" action="<?php echo e(URL::to('/submit-add-blog')); ?>" id="form-add-blog" data-toggle="validator" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row"> 
                                <div class="col-md-12">
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views\admin\blog\add-blog.blade.php ENDPATH**/ ?>