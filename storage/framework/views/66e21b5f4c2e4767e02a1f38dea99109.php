...
<form action="<?php echo e(URL::to('/submit-add-product')); ?>" method="POST" id="form-add-product" data-toggle="validator" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views/admin/product/add-product.blade.php ENDPATH**/ ?>