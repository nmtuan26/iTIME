        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form  method="post" action="<?php echo e(URL::to('/submit-edit-blog/'.$blog->idBlog)); ?>" id="form-add-blog" data-toggle="validator" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row"> 
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Tiêu đề *</label>
                                        <input type="text" name="BlogTitle" value="<?php echo e($blog->BlogTitle); ?>" class="form-control slug" onkeyup="ChangeToSlug()" placeholder="Nhập tiêu đề tin tức" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <input type="hidden" name="BlogSlug" value="<?php echo e($blog->BlogSlug); ?>" class="form-control" id="convert_slug">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex flex-wrap" id="image-list">
                                            <div id="image-item-0" class="image-item">
                                                <img src="<?php echo e(asset('storage/kidoldash/images/blog/'.$blog->BlogImage)); ?>" class="img-fluid rounded avatar-100 mr-3 mt-2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="BlogDesc"><?php echo e($blog->BlogDesc); ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="BlogContent"><?php echo e($blog->BlogContent); ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" data-style="py-0" name="Status">
                                            <option value="<?php echo e($blog->Status); ?>">
                                                <?php if($blog->BlogStatus == 0): ?> Ẩn
                                                <?php else: ?> Hiện
                                                <?php endif; ?>
                                            </option>
                            ...
                            <a href="<?php echo e(URL::to('/manage-blog')); ?>" class="btn btn-light mr-2">Trở Về</a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views/admin/blog/edit-blog.blade.php ENDPATH**/ ?>