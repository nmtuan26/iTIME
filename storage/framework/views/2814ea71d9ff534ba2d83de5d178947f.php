        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(URL::to('/submit-add-staffs')); ?>" id="form-insert-users" data-toggle="validator">
                            <?php echo csrf_field(); ?>
                            <?php
                            ...
                            <a href="<?php echo e(URL::to('/manage-staffs')); ?>" class="btn btn-light mr-2">Trở Về</a>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views\admin\manage-users\add-staffs.blade.php ENDPATH**/ ?>