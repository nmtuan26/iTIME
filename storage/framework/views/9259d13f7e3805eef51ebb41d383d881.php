        ...
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <!-- <div class="shop-banner">
                    <a href="#"><img src="<?php echo e(asset('kidolshop/images/banner/banner.png')); ?>" alt=""></a>
                </div> -->
                <!--Shop Top Bar Start-->
            ...
            <div class="col-lg-3">
                <div class="shop-sidebar">
                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="categories-list">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <span style="margin-left:auto">(<?php echo e(App\Models\Product::where('idCategory',$category->idCategory)->where('StatusPro','1')->count()); ?>)</span>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-categories">
                        ...
                        <?php $__currentLoopData = $list_brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="d-flex align-items-center">
                                ...
                                <span style="margin-left:auto">(<?php echo e(App\Models\Product::where('idBrand',$brand->idBrand)->where('StatusPro','1')->count()); ?>)</span>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-banner">
                        <a href="#"><img src="kidolshop/images/day.jpg" alt=""></a>
                    </div>
                    <!--Sidebar Size End-->
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views/shop/product/shop-all-product.blade.php ENDPATH**/ ?>