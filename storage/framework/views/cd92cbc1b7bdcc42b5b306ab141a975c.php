                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show" id="chang-pwd" role="tabpanel">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(URL::to('/submit-change-adpassword')); ?>" id="form-changepassword">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views\admin\my-account\change-adpassword.blade.php ENDPATH**/ ?>