...
<form action="<?php echo e(URL::to('/submit-add-voucher')); ?>" method="POST" id="form-add-voucher" data-toggle="validator" enctype="multipart/form-data" autocomplete="off">
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views/admin/product/voucher/add-voucher.blade.php ENDPATH**/ ?>