        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(URL::to('/submit-add-attr-value')); ?>" method="POST" data-toggle="validator">
                            <?php echo csrf_field(); ?>
                            <div class="row"> 
                                <?php
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views\admin\product\product-attribute\attribute-value\add-attr-value.blade.php ENDPATH**/ ?>