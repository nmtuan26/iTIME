...
<form action="<?php echo e(URL::to('/submit-add-sale')); ?>" method="POST" id="form-add-sale" data-toggle="validator" enctype="multipart/form-data" autocomplete="off">
<?php echo csrf_field(); ?>
            ...
            <div class="col-sm-12 alert-pd">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(URL::to('/manage-sale')); ?>" class="btn btn-light">Trở về</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="product-item col-md-3 select-pd" id="product-item-<?php echo e($product->idProduct); ?>" data-id="<?php echo e($product->idProduct); ?>">
                    <div class="product-image mb-3" id="product-image-<?php echo e($product->idProduct); ?>">

                        <?php $image = json_decode($product->ImageName)[0];?>
                        <label for="chk-pd-<?php echo e($product->idProduct); ?>"><img src="<?php echo e(asset('storage/kidoldash/images/product/'.$image)); ?>" class="rounded w-100 img-fluid"/></label>

                        <div class="product-title">
                            <div class="product-name">
                                <input type="checkbox" class="checkstatus d-none" id="chk-pd-<?php echo e($product->idProduct); ?>" name="chk_product[]" value="<?php echo e($product->idProduct); ?>" data-id="<?php echo e($product->idProduct); ?>" data-name="<?php echo e($product->ProductName); ?>" data-price="<?php echo e($product->Price); ?>" data-img="<?php echo e($image); ?>">
                                <span><?php echo e($product->ProductName); ?></span>
                            </div>
                            <div style="text-align:center;"><?php echo e(number_format($product->Price,0,',','.').' '.'đ'); ?></div>
                        </div>
                    </div>
                    <input type="hidden" name="selected_product[]" id="product-<?php echo e($product->idProduct); ?>" value="" />
                </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doan\resources\views/admin/product/sale/add-sale.blade.php ENDPATH**/ ?>