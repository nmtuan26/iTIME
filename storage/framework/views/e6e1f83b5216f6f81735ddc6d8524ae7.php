...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="<?php echo e(asset('kidoldash/vendor/remixicon/fonts/remixicon.css')); ?>">
    </head>
  <body class="  ">
    <!-- loader Start -->
    <div id="loading">
    ...
    <div class="wrapper">
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="<?php echo e(URL::to('/dashboard')); ?>" class="header-logo">
                <img src="<?php echo e(asset('kidoldash/images/logo.png')); ?>" class="img-fluid rounded-normal light-logo" alt="logo">
                  <h5 class="logo-title light-logo ml-2">Itime quản trị</h5>
              </a>
              ...
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      <li class="<?php echo e(Request::is('dashboard') ? 'active' : ''); ?>">
                          <a href="<?php echo e(URL::to('/dashboard')); ?>" class="svg-icon">                        
                      ...
                      <li class=" ">
                          ...
                          <ul id="purchase" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li class="<?php echo e(Request::is('list-bill') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/list-bill')); ?>">
                                        <i class="las la-minus"></i><span>Danh Sách Đơn Hàng</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(Request::is('waiting-bill') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/waiting-bill')); ?>">
                                        <i class="las la-minus"></i><span>Đơn Chờ Xác Nhận</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(Request::is('shipping-bill') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/shipping-bill')); ?>">
                                        <i class="las la-minus"></i><span>Đơn Đang Giao</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(Request::is('shipped-bill') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/shipped-bill')); ?>">
                                        <i class="las la-minus"></i><span>Đơn Đã Giao</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(Request::is('cancelled-bill') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/cancelled-bill')); ?>">
                                        <i class="las la-minus"></i><span>Đơn Đã Hủy</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(Request::is('confirmed-bill') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/confirmed-bill')); ?>">
                      ...
                      <li class=" ">
                          ...
                          <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="<?php echo e(Request::is('manage-products') ? 'active' : ''); ?>">
                                  <a href="<?php echo e(URL::to('/manage-products')); ?>">
                                      <i class="las la-minus"></i><span>Danh Sách Sản Phẩm</span>
                                  </a>
                              </li>
                              <li class="<?php echo e(Request::is('add-product') ? 'active' : ''); ?>">
                              ...
                              <li class="">
                                ...
                                <ul id="attribute" class="iq-submenu collapse" data-parent="#product">
                                    <li class="<?php echo e(Request::is('manage-attribute') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::to('/manage-attribute')); ?>">
                                            <i class="las la-minus"></i><span>Nhóm Phân Loại</span>
                                        </a>
                                    </li>
                                    <li class="<?php echo e(Request::is('manage-attr-value') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::to('/manage-attr-value')); ?>">
                              ...
                              <li class="">
                                ...
                                <ul id="discount" class="iq-submenu collapse" data-parent="#product">
                                    <li class="<?php echo e(Request::is('manage-sale') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::to('/manage-sale')); ?>">
                                            <i class="las la-minus"></i><span>Danh Sách Khuyến Mãi</span>
                                        </a>
                                    </li>
                                    <li class="<?php echo e(Request::is('add-sale') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::to('/add-sale')); ?>">
                              ...
                              <li class="">
                                ...
                                <ul id="voucher" class="iq-submenu collapse" data-parent="#product">
                                    <li class="<?php echo e(Request::is('manage-voucher') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::to('/manage-voucher')); ?>">
                                            <i class="las la-minus"></i><span>Danh Sách Mã</span>
                                        </a>
                                    </li>
                                    <li class="<?php echo e(Request::is('add-voucher') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::to('/add-voucher')); ?>">
                      ...
                      <li class=" ">
                          ...
                          <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="<?php echo e(Request::is('manage-category') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/manage-category')); ?>">
                                              <i class="las la-minus"></i><span>Danh Sách Danh Mục</span>
                                          </a>
                                  </li>
                                  <li class="<?php echo e(Request::is('add-category') ? 'active' : ''); ?>">
                      ...
                      <!-- <li class=" ">
                          ...
                          <ul id="brand" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="<?php echo e(Request::is('manage-brand') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/manage-brand')); ?>">
                                              <i class="las la-minus"></i><span>Danh Sách Thương Hiệu</span>
                                          </a>
                                  </li>
                                  <li class="<?php echo e(Request::is('add-brand') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/add-brand')); ?>">
                      ...
                      <li class=" ">
                          ...
                          <ul id="people" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="<?php echo e(Request::is('manage-customers') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/manage-customers')); ?>">
                                              <i class="las la-minus"></i><span>Danh Sách Tài Khoản Khách Hàng</span>
                                          </a>
                                  </li>
                                  <li class="<?php echo e(Request::is('manage-staffs') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/manage-staffs')); ?>">
                                              <i class="las la-minus"></i><span>Danh Sách Nhân Viên</span>
                                          </a>
                                  </li>
                                  <li class="<?php echo e(Request::is('add-staffs') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/add-staffs')); ?>">
                      ...
                      <li class=" ">
                          ...
                          <ul id="myaccount" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="<?php echo e(Request::is('my-adprofile') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/my-adprofile')); ?>">
                                              <i class="las la-minus"></i><span>Hồ Sơ Của Tôi</span>
                                          </a>
                                  </li>
                                  <li class="<?php echo e(Request::is('edit-adprofile') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/edit-adprofile')); ?>">
                                              <i class="las la-minus"></i><span>Sửa Hồ Sơ</span>
                                          </a>
                                  </li>
                                  <li class="<?php echo e(Request::is('change-adpassword') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(URL::to('/change-adpassword')); ?>">
                     ...
                     <!-- <li class=" ">
                          ...
                          <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li class="<?php echo e(Request::is('manage-blog') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/manage-blog')); ?>">
                                        <i class="las la-minus"></i><span>Danh sách tin tức</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(Request::is('add-blog') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/add-blog')); ?>">
                  ...
                  <div class="card border-none">
                      <div class="card-body p-0">
                          <div class="sidebarbottom-content">
                              <div class="image"><img src="<?php echo e(asset('kidoldash/images/layouts/side-bkg.png')); ?>" class="img-fluid" alt="side-bkg"></div>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="iq-navbar-custom">
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                      ...
                      <a href="<?php echo e(URL::to('/dashboard')); ?>" class="header-logo">
                          <img src="<?php echo e(asset('kidoldash/images/logo.png')); ?>" class="img-fluid rounded-normal" alt="logo">
                          <h5 class="logo-title ml-3">Itime</h5>
                          ...
                          <ul class="navbar-nav ml-auto navbar-list align-items-center">
                              <li class="nav-item nav-icon dropdown">
                                  <a href="#" class="search-toggle dropdown-toggle btn border add-btn"
                                      ...
                                      aria-expanded="false">
                                      <img src="<?php echo e(asset('kidoldash/images/small/Vietnam-Flag.png')); ?>" alt="img-flag"
                                      ...
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-3">
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('kidoldash/images/small/flag-02.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">French</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('kidoldash/images/small/flag-03.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">Spanish</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('kidoldash/images/small/flag-04.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">Italian</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('kidoldash/images/small/flag-05.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">German</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('kidoldash/images/small/flag-06.png')); ?>" alt="img-flag"
                                              ...
                                              <div class="px-3 pt-0 pb-0 sub-card">
                                                      ...
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('kidoldash/images/user/01.jpg')); ?>" alt="01">
                                                          </div>
                                                  ...
                                                  <a href="#" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('kidoldash/images/user/02.jpg')); ?>" alt="02">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                                                  ...
                                                  <a href="#" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('kidoldash/images/user/03.jpg')); ?>" alt="03">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                                              ...
                                              <div class="px-3 pt-0 pb-0 sub-card">
                                                  <a href="#" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('kidoldash/images/logo.png')); ?>" alt="01">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                      data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                       <?php if($avatar != ''): ?>
                                        <img src="<?php echo e(asset('storage/kidoldash/images/user/'.$avatar)); ?>" class="img-fluid rounded" alt="user">
                                       <?php else: ?>
                                        <img src="<?php echo e(asset('kidoldash/images/user/12.jpg')); ?>" class="img-fluid rounded" alt="user">
                                       <?php endif; ?>
                                  </a>
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 text-center">
                                              <div class="media-body profile-detail text-center">
                                                  <img src="<?php echo e(asset('kidoldash/images/page-img/profile-bg.jpg')); ?>" alt="profile-bg"
                                                      class="rounded-top img-fluid mb-4">
                                                  <?php if($avatar != null): ?>
                                                  <img src="<?php echo e(asset('storage/kidoldash/images/user/'.$avatar)); ?>" alt="profile-img"
                                                      class="rounded profile-img img-fluid avatar-70">
                                                  <?php else: ?>
                                                  <img src="<?php echo e(asset('kidoldash/images/user/12.jpg')); ?>" alt="profile-img"
                                                      class="rounded profile-img img-fluid avatar-70">
                                                  <?php endif; ?>
                                              </div>
                                              <div class="p-3">
                                                  ...
                                                  <div class="d-flex align-items-center justify-content-center mt-3">
                                                        ...
                                                        <a href="<?php echo e(URL::to('/admin-logout')); ?>" class="btn border">Đăng Xuất</a>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
      ...
      <?php echo $__env->yieldContent('content_dash'); ?>
...
<script src="<?php echo e(asset('kidoldash/js/ckeditor/ckeditor.js')); ?>"></script>

<link rel="stylesheet" type="text/css" href="<?php echo e(asset('kidoldash/datetimepicker-master/jquery.datetimepicker.css')); ?>">
<script src="<?php echo e(asset('kidoldash/datetimepicker-master/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('kidoldash/datetimepicker-master/build/jquery.datetimepicker.full.min.js')); ?>"></script>
<script src="<?php echo e(asset('kidoldash/js/moment.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\doan\resources\views/admin_layout.blade.php ENDPATH**/ ?>